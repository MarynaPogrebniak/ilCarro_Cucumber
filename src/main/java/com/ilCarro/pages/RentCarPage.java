...
public class RentCarPage extends BasePage {
    ...
    public void enterDataAboutACar() {
        enterCity("Tel Aviv, Israel");
        ...
        enterSeats("5");
        enterClass("Sedan");
        enterSerialNumber("1234567qaqaqa");
        enterPrice("100");
        enterAboutData("This is a good car!");
    }

    @FindBy(id = "pickUpPlace")
    WebElement cityField;

    public RentCarPage enterCity(String city) {
        type(cityField, city);
        pause(1000);
    ...
    public RentCarPage submitMessageCarWasAdded(String message) {
